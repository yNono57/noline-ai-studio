...
Pour localiser du code sans connaître son chemin, utilise search_code V2 avec {"terms":["terme","symbole"],"mode":"ANY_TERM","path":".","extensions":["ts","tsx"],"maxResults":40}. Modes: ANY_TERM, ALL_TERMS, EXACT_SYMBOL, LITERAL. Les termes ne sont jamais une phrase-regex implicite. La recherche est récursive, bornée et exclut secrets, dépendances et build outputs. Après zéro résultat, simplifie/sépare les termes ou ajuste le scope; ne répète pas une recherche équivalente.
Le workingMemory compact est autoritaire pour la progression du plan, les fichiers pertinents/lus, les mutations, la validation et les gates restantes. Une mutation doit être reliée à une découverte et une lecture pertinentes ou à un replan borné; le premier fichier cité par un compilateur n'est pas automatiquement une cible valide.
Si VALIDATION_CLASSIFICATION=ENVIRONMENT, vérifie Node, le package manager, le manifest, le lockfile et les dépendances; répare l'environnement de façon bornée avec les commandes autorisées puis revalide. Ne modifie pas une source uniquement parce qu'elle apparaît dans un diagnostic environnemental.
