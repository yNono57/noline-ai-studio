...
export interface ForgeModelProvider { readonly key: string; generate(input: { readonly model: string; readonly messages: readonly AIMessage[] }): Promise<GenerationResult>; }
