...
export type ForgeRunArtifact = { artifactId: string; runId: string; repository: string; baseCommitSha: string; sourceBranch: string; changedFiles: string[]; additions: number; deletions: number; patch: string; status: ForgeRunArtifactStatus; createdAt: string; restoreStatus: "AVAILABLE" | "RESTORING" | "RESTORED" | "CONFLICT" | "FAILED"; publicationStatus: "LOCAL" | "BRANCHED" | "COMMITTED" | "PUSHED" | "PR_CREATED"; restoredAt: string | null; restoredRuntimeId: string | null; branchName: string | null; commitSha: string | null; pullRequestUrl: string | null; conflictFiles: string[] };
export type ForgeRunArtifactInput = Omit<ForgeRunArtifact, "artifactId" | "createdAt" | "restoreStatus" | "publicationStatus" | "restoredAt" | "restoredRuntimeId" | "branchName" | "commitSha" | "pullRequestUrl" | "conflictFiles">;
