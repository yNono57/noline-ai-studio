...
export function ForgeWorkspace() {
  ...
  return <div className="space-y-5">
    ...
    <div className="grid min-h-[68vh] gap-4 xl:grid-cols-[17rem_minmax(0,1fr)_17rem]">
      ...
      <main ref={conversationSection} className="surface premium-border relative flex h-[75dvh] min-h-[32rem] max-h-[52rem] min-w-0 flex-col overflow-hidden rounded-xl shadow-premium xl:h-[68vh]">
